...
```text
artifacts\BetterTaskManager-v1.1.0-preview.56-portable-win-x64.zip
...
This produces `artifacts\BetterTaskManager-v1.1.0-preview.56-setup-win-x64.exe` and `artifacts\SHA256SUMS-v1.1.0-preview.56.txt`. CI uploads the installer, portable folder/ZIP, and release checksum manifest together.
