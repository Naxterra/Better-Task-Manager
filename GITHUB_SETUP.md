...
```powershell
Compress-Archive `
  -LiteralPath .\artifacts\BetterTaskManager-v1.1.0-preview.31-portable-win-x64 `
  -DestinationPath .\artifacts\BetterTaskManager-v1.1.0-preview.31-portable-win-x64.zip `
