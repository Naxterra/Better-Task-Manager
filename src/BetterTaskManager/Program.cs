...
#pragma warning restore WFO5001
        ...
        public static string SelfTest()
        {
            ...
            {
                if (Application.ProductVersion != "1.1.0-preview.37" || form.Text != "Better Task Manager v1.1.0-preview.37")
                {
                    throw new InvalidOperationException("Application version metadata and window title do not match 1.1.0-preview.37.");
                }
